export const dict = {
  ...
  "browser.panel.empty": "Enter a URL or search query to open a page in this side panel.",
  "browser.panel.localServers": "Local",
  "browser.panel.scanning": "Scanning for local servers...",
  "browser.panel.noServers": "No local dev servers detected",
  "browser.panel.placeholder": "Search or enter address",
  "browser.panel.newTab": "New tab",
  "browser.panel.reload": "Reload",
  "browser.panel.forceReload": "Force reload",
  "browser.panel.zoom": "Zoom",
  "browser.panel.zoomIn": "Zoom in",
  "browser.panel.zoomOut": "Zoom out",
  "browser.panel.zoomReset": "Reset zoom",
  "browser.panel.clearCookies": "Clear cookies",
  "browser.panel.clearCache": "Clear cache",
  "browser.panel.menu": "Browser menu",
  "browser.panel.stop": "Stop loading",
  "browser.panel.openExternal": "Open in default browser",
  "browser.panel.unsupported.title": "Unsupported address",
  "browser.panel.unsupported.description": "OpenCode Browser only loads http and https pages.",
  "browser.panel.failed.title": "Page failed to load",
  "browser.panel.failed.description": "The page could not be loaded.",
